  ...
  const plans = [
    {
      ...
      price: '₹399',
      period: '/month',
      subtitle: 'For interns, freelancers, and junior architects.',
      features: [
        'Base Mode only',
        'Q&A on drawings (Interior-focused)',
        'Detects basic drafting issues (dimensions, labels, overlaps)',
        'Limited checks: 20–30 drawings/month',
        'Basic PDF report',
        'Single-user access'
      ],
      note: 'Ideal for developing drawing hygiene and adopting AI-assisted drafting.',
      highlight: 'No code compliance. Purely drawing correctness.',
      color: 'from-gray-400 to-gray-500',
      popular: false
    },
    {
      id: 'essential',
      name: 'ESSENTIAL — Tier 2',
      price: '₹1,999',
      period: '/month',
      subtitle: 'For small studios (1–5 people). Your main revenue driver tier.',
      features: [
        'Base + Plus Mode',
        'NBC standard checks on sections, plans & elevations',
        '100–120 drawings per month (safe limit)',
        'Enhanced code-referenced PDF reports',
        '2–3 team members',
        'Basic batch processing (5–10 files)',
        'Project folders',
        'Partial blockchain encryption (upload → lock only)'
      ],
      note: 'Perfect for small firms doing weekly drawing reviews.',
      highlight: 'Saves 6–10 hours every week on manual checking.',
      color: 'from-blue-500 to-blue-600',
      popular: true
    },
    {
      ...
      price: '₹4,999',
      period: '/month',
      subtitle: 'For mid-size studios, consultants, and agencies.',
      features: [
        'Base + Plus + Partial Code Mode',
        'Advanced rule-based zoning checks',
        'Fire safety, accessibility, ventilation & functional agents',
        '250–300 drawings per month (safe limit)',
        'Full batch processing (unlimited queue + parallel checks)',
        'Up to 10 users',
        'Advanced PDF reports + “Starline Pre-Checked” stamp',
        'Team dashboard',
        'Full blockchain encryption backend',
        'Version comparison (Rev 1 → Rev 2 → Rev 3)',
        'Priority support'
      ],
      note: 'Designed for studios producing municipal drawings and large submissions.',
      highlight: 'Your strongest revenue engine.',
      color: 'from-purple-500 to-purple-600',
      popular: false
    },
    {
      ...
      price: 'Custom 1 lack / year onward.',
      period: '',
      subtitle: 'For large firms, developers, PMCs & infra companies.',
      features: [
        'Full Base + Plus + Code Mode',
        'Qualitative + Quantitative compliance agents',
        'Unlimited drawings',
        'Custom rule-sets (state, city, project)',
        'On-premise / VPC deployment',
        'API access + integrations (OBPAS, internal QC)',
        'Dedicated account manager',
        'Custom workflows for townships, malls, hospitals, high-rise',
        'Full blockchain encryption + audit trail',
        'White-label reports + compliance certificates'
      ],
      color: 'from-slate-600 to-slate-700',
      popular: false
    }
    ...
    <div className="relative min-h-screen bg-gradient-to-br from-gray-50 via-gray-100 to-gray-200 overflow-hidden">
      ...
      <div className="relative z-10">
        ...
        <header className="pt-20 pb-16 px-4 text-center">
          <div className="inline-block mb-4 px-4 py-2 bg-white/60 backdrop-blur-sm rounded-full border border-gray-200">
            <span className="text-sm font-medium text-gray-600">Starline AI</span>
          </div>
          <h1 className="text-5xl md:text-6xl font-bold text-gray-900 mb-6 tracking-tight">
            Choose Your Plan
          </h1>
          <p className="text-xl text-gray-600 max-w-3xl mx-auto leading-relaxed">
            From drafting hygiene to full municipal compliance — pick a tier that fits your workflow.
          </p>
        </header>
        ...
        <div className="text-center pb-20 px-4">
          <div className="max-w-2xl mx-auto bg-white/60 backdrop-blur-md rounded-2xl p-8 shadow-xl border border-gray-200">
            ...
            <p className="text-gray-600 mb-6">
              Schedule a demo with our team and find the perfect fit for your workflow.
            </p>
            <button onClick={openWishlist} className="px-8 py-3 bg-gradient-to-r from-gray-800 to-gray-900 text-white rounded-xl font-semibold hover:shadow-lg transition-all duration-300 hover:scale-105">
              Schedule a Demo
            </button>
